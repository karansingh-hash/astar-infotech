...
import {Menu, X, Code2, Globe, ShoppingCart, Smartphone, Settings, Search, ArrowRight, Star, MapPin, Phone, Mail, Clock, Users, Award, Zap, Heart, ChevronRight, Send, Facebook, Instagram, Linkedin, Youtube, MessageCircle, ChevronUp, Sparkles, Target, Shield, Rocket, Sun, Moon, Home as HomeIcon} from 'lucide-react'
...
<div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-8 md:gap-12">
<div className="flex-1 text-center md:text-left"><h2 className={`text-2xl sm:text-4xl font-bold text-white ${th}`}>Ready to Take Your Business Online?</h2><p className="mt-3 text-white/80 text-sm md:text-lg max-w-2xl">Let&apos;s build something amazing together. Get in touch today for a free consultation.</p><div className="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-center md:justify-start gap-3"><a href="#contact"><Button size="lg" className="bg-white hover:bg-white/90 text-neon font-semibold px-6 h-12 sm:h-14 shadow-lg min-h-[44px] rounded-xl">Get Free Consultation<ArrowRight className="ml-2 w-4 h-4"/></Button></a><a href="https://wa.me/918560074448" target="_blank" rel="noopener noreferrer"><Button size="lg" className="border-white/30 text-white bg-white/10 hover:bg-white/20 px-6 h-12 sm:h-14 backdrop-blur-sm min-h-[44px] rounded-xl"><MessageCircle className="mr-2 w-4 h-4"/>WhatsApp</Button></a></div></div>
<div className="flex-shrink-0 w-64 sm:w-72 md:w-80"><img src="/cta-animation.png" alt="Launch your business online - digital transformation rocket illustration" className="w-full animate-[float_6s_ease-in-out_infinite] drop-shadow-2xl"/></div>
</div>
</section>
