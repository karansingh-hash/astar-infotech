...
<div><h4 className="font-semibold text-foreground mb-3 text-sm uppercase tracking-wider">Our Services</h4><ul className="space-y-2">{svs.map(sv=><li key={sv.t}><a href="#services" className="text-sm text-muted-foreground hover:text-neon transition-colors min-h-[32px] flex items-center gap-2">{sv.t}</a></li>)}</ul></div>
